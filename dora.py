...
async def filter_versions_newer_than(
    ...
    for version in all_versions:
        descriptor: cm.ComponentDescriptor = await component_descriptor_lookup(
...
async def create_deployment_objects(
    ...
    async def create_deployment_object_for_update(
        ...
        old_ref_component: cm.Component = (await component_descriptor_lookup(
            cm.ComponentIdentity(
        ...
        new_ref_component: cm.Component = (await component_descriptor_lookup(
            cm.ComponentIdentity(
                name=cnudie.util.to_component_name(target_update.referenced_component),
