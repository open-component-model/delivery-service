...
def auth_middleware(
    ...
    async def middleware(
        ...
        request['github_user'] = GithubUser(
            username=subject,
        ...
        if github_oAuth:
            request['user_permissions'] = get_permissions_for_github_oAuth(github_oAuth)
        else:
            request['user_permissions'] = get_user_permissions(subject)
