...
class DownloadTestResults(aiohttp.web.View):
    ...
    async def get(self):
        ...
        gh_api = self.request.app[consts.GITHUB_API_LOOKUP](component_name)
        repo = self.request.app[consts.GITHUB_REPO_LOOKUP](component_name)
        ...
        component_with_tests_callback = self.request.app[consts.COMPONENT_WITH_TESTS_CALLBACK]
