...
class GroupProperties:
    ...
    def group_id_for_artefact(
        ...
        '''
        Creates a stable representation of the grouping relevant properties of the `artefact`.
        '''
        id = ''
    ...
    def strip_artefact(
        self,
        artefact: dso.model.ComponentArtefactId,
        keep_group_properties: bool=True,
    ) -> dso.model.ComponentArtefactId:
        '''
        Based on `keep_group_properties`, either returns an artefact which only contains the
        properties which are used for grouping, or the opposite.
        '''
        def include_property(is_group_property: bool) -> bool:
            return is_group_property == keep_group_properties

        return dso.model.ComponentArtefactId(
            component_name=artefact.component_name if include_property(self.component_name) else None, # noqa: E501
            component_version=artefact.component_version if include_property(self.component_version) else None, # noqa: E501
            artefact_kind=artefact.artefact_kind if include_property(self.artefact_kind) else None,
            artefact=dso.model.LocalArtefactId(
                artefact_name=artefact.artefact.artefact_name if include_property(self.artefact_name) else None, # noqa: E501
                artefact_version=artefact.artefact.artefact_version if include_property(self.artefact_version) else None, # noqa: E501
                artefact_type=artefact.artefact.artefact_type if include_property(self.artefact_type) else None, # noqa: E501
                artefact_extra_id=artefact.artefact.artefact_extra_id if include_property(self.artefact_extra_id) else dict(), # noqa: E501
            ),
        )
...
class FindingIssues:
    ...
    :param GroupProperties grouping:
        Allows a custom configuration of those properties, which should be used to group artefacts
    ...
    grouping: GroupProperties = dataclasses.field(default_factory=GroupProperties.default)
